...
class _EvenementTile extends StatelessWidget {
  ...
  Color get _couleurStatut => switch (evenement.statut) {
        StatutEvenement.planifie => AppColors.texteSecondaire,
        StatutEvenement.actif => AppColors.or,
        StatutEvenement.termine => AppColors.palme,
      };
                ...
                Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(evenement.statut.libelle,
                          style: TextStyle(
                              fontSize: 10,
