...
const menuSurface =
  "z-50 min-w-[13rem] overflow-hidden rounded-lg border bg-popover p-1.5 text-popover-foreground shadow-card " +
...
const itemBase =
  ...
  "focus:bg-muted data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:size-4 [&_svg]:shrink-0 [&_svg]:text-muted-foreground";
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem ref={ref} checked={checked} className={cn(itemBase, "pl-8", className)} {...props}>
...
>(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger ref={ref} className={cn(itemBase, "data-[state=open]:bg-muted", className)} {...props}>
    {children}
